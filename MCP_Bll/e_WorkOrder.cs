...
namespace Maticsoft.BLL
{
	...
	{
		private readonly Maticsoft.DAL.e_WorkOrder dal=new Maticsoft.DAL.e_WorkOrder();
		public e_WorkOrder()
		{}
		#region  BasicMethod
		/// <summary>
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Maticsoft.Model.e_WorkOrder GetModelByCache(decimal ID_Key)
		{
			
			string CacheKey = "e_WorkOrderModel-" + ID_Key;
			...
			return (Maticsoft.Model.e_WorkOrder)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Maticsoft.Model.e_WorkOrder> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Maticsoft.Model.e_WorkOrder> DataTableToList(DataTable dt)
		{
			List<Maticsoft.Model.e_WorkOrder> modelList = new List<Maticsoft.Model.e_WorkOrder>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Maticsoft.Model.e_WorkOrder model;
