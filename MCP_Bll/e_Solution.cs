...
namespace Maticsoft.BLL
{
	...
	{
		private readonly Maticsoft.DAL.e_Solution dal=new Maticsoft.DAL.e_Solution();
		public e_Solution()
		{}
		#region  BasicMethod
		/// <summary>
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Maticsoft.Model.e_Solution GetModelByCache(decimal ID_Key)
		{
			
			string CacheKey = "e_SolutionModel-" + ID_Key;
			...
			return (Maticsoft.Model.e_Solution)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Maticsoft.Model.e_Solution> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Maticsoft.Model.e_Solution> DataTableToList(DataTable dt)
		{
			List<Maticsoft.Model.e_Solution> modelList = new List<Maticsoft.Model.e_Solution>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Maticsoft.Model.e_Solution model;
