...
namespace Maticsoft.BLL
{
	...
	{
		private readonly Maticsoft.DAL.MaterialInfo dal=new Maticsoft.DAL.MaterialInfo();
		public MaterialInfo()
		{}
		#region  BasicMethod
		/// <summary>
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Maticsoft.Model.MaterialInfo GetModelByCache(string MaterialID)
		{
			
			string CacheKey = "MaterialInfoModel-" + MaterialID;
			...
			return (Maticsoft.Model.MaterialInfo)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Maticsoft.Model.MaterialInfo> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Maticsoft.Model.MaterialInfo> DataTableToList(DataTable dt)
		{
			List<Maticsoft.Model.MaterialInfo> modelList = new List<Maticsoft.Model.MaterialInfo>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Maticsoft.Model.MaterialInfo model;
