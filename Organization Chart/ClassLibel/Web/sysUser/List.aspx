<%@ Page Title="sysUser" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Maticsoft.Web.sysUser.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="Privilege" HeaderText="Privilege" SortExpression="Privilege" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="ID_Key" HeaderText="ID_Key" SortExpression="ID_Key" ItemStyle-HorizontalAlign="Center"  /> 
