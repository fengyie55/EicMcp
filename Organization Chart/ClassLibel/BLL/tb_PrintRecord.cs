...
namespace Maticsoft.BLL
{
	...
	public partial class tb_PrintRecord
	{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Maticsoft.Model.tb_PrintRecord GetModelByCache(decimal ID_Key)
		{
			...
			return (Maticsoft.Model.tb_PrintRecord)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Maticsoft.Model.tb_PrintRecord> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Maticsoft.Model.tb_PrintRecord> DataTableToList(DataTable dt)
		{
			List<Maticsoft.Model.tb_PrintRecord> modelList = new List<Maticsoft.Model.tb_PrintRecord>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Maticsoft.Model.tb_PrintRecord model;
