...
namespace Maticsoft.DAL
{
	...
	public partial class e_ReworkProcess
	{
		...
		public bool Exists(decimal ID_Key)
		{
			...
			strSql.Append("select count(1) from tb_e_ReworkProcess");
		...
		/// 增加一条数据
		/// </summary>
		public decimal Add(Maticsoft.Model.e_ReworkProcess model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into tb_e_ReworkProcess(");
			strSql.Append("RejectsNum,ProNum)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Maticsoft.Model.e_ReworkProcess model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update tb_e_ReworkProcess set ");
		...
		public bool Delete(decimal ID_Key)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from tb_e_ReworkProcess ");
			strSql.Append(" where ID_Key=@ID_Key");
			SqlParameter[] parameters = {
					new SqlParameter("@ID_Key", SqlDbType.Decimal)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.e_ReworkProcess GetModel(decimal ID_Key)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ID_Key,RejectsNum,ProNum from tb_e_ReworkProcess ");
			strSql.Append(" where ID_Key=@ID_Key");
			SqlParameter[] parameters = {
					new SqlParameter("@ID_Key", SqlDbType.Decimal)
			};
			...
			Maticsoft.Model.e_ReworkProcess model=new Maticsoft.Model.e_ReworkProcess();
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.e_ReworkProcess DataRowToModel(DataRow row)
		{
			Maticsoft.Model.e_ReworkProcess model=new Maticsoft.Model.e_ReworkProcess();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID_Key,RejectsNum,ProNum ");
			strSql.Append(" FROM tb_e_ReworkProcess ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" ID_Key,RejectsNum,ProNum ");
			strSql.Append(" FROM tb_e_ReworkProcess ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from tb_e_ReworkProcess T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "tb_e_ReworkProcess";
