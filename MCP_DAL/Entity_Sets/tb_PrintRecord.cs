...
namespace Maticsoft.DAL
{
	...
	public partial class tb_PrintRecord
	{
        ...
        {
            string strSql = " SELECT COUNT(SN) AS Count FROM tb_PrintRecord WHERE  " + strsql;
		...
		public Maticsoft.Model.PrintRecord GetModel(decimal ID_Key)
		{
			...
			Maticsoft.Model.PrintRecord model=new Maticsoft.Model.PrintRecord();
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.PrintRecord DataRowToModel(DataRow row)
		{
			Maticsoft.Model.PrintRecord model=new Maticsoft.Model.PrintRecord();
			if (row != null)
			{
