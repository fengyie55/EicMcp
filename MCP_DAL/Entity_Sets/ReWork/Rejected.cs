...
namespace Maticsoft.DAL
{
	...
	public partial class Rejected
	{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Rejected ");
        ...
        {
            string temSql = "select  *  from tb_Rejected  where RejectCode= '"+RejectCode+"'";
            if (dbs.ExecuteSql(temSql) > 0)
            {
                return true;
            }
            else { return false; }
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,RejectCode,Reject,Descriptions,Picture,Notes ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" ID,RejectCode,Reject,Descriptions,Picture,Notes ");
			strSql.Append(" FROM tb_Rejected ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Rejected T ");
