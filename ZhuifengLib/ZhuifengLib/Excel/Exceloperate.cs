...
namespace ZhuifengLib
{
    ...
    class ExcelOperate
    {
        ...
        public bool DataSetToExcel(DataSet dataSet, bool isShowExcle)
        {
            ...
            var rowNumber = dataTable.Rows.Count;//不包括字段名
            var columnNumber = dataTable.Columns.Count;
            var colIndex = 0;
            ...
            var objData = new object[rowNumber, columnNumber];
        ...
        public bool DataSetToExcel(DataSet dataSet, string fileName, bool isShowExcle)
        {
            ...
            {
                workbook.Close(XlSaveAction.xlSaveChanges, Missing.Value, Missing.Value);
                excel.Quit();
            }
